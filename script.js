...
function updateRecordingDuration() {
    ...
    document.getElementById("recordingDuration").textContent = `${String(minutes).padStart(2, "0")}:${String(seconds).padStart(2, "0")}`;
}
...
function listRecordings() {
    ...
    cursorRequest.onsuccess = function(event) {
        ...
        if (cursor) {
            ...
            playButton.className = "border border-gray-300 text-gray-300 hover:bg-gray-700 mr-2 px-2 py-1 rounded";
            stopButton.textContent = "⏹️";
            stopButton.className = "border border-gray-300 text-gray-300 hover:bg-gray-700 mr-2 px-2 py-1 rounded";
            downloadButton.textContent = "Baixar";
            downloadButton.className = "border border-gray-300 text-gray-300 hover:bg-gray-700 mr-2 px-2 py-1 rounded";
            deleteButton.textContent = "❌";
            deleteButton.className = "border border-gray-300 text-gray-300 hover:bg-gray-700 px-2 py-1 rounded";
